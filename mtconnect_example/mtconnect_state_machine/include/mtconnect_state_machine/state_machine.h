...
static std::map<int, std::string> STATE_MAP =
    boost::assign::map_list_of(INVALID, "INVALID")(IDLE, "IDLE")(INITING, "INITING")
    (CHECK_HOME, "CHECK_HOME")(WAIT_FOR_ACTIONS, "WAIT_FOR_ACTIONS")(WAIT_FOR_SERVICES, "WAIT_FOR_SERVICES")
    ...
    (ABORTING, "ABORTING")
    (ABORT_GOALS, "ABORT_GOALS")(CANCEL_REQUESTS, "CANCEL_REQUESTS")(ABORTED, "ABORTED")
    (RESETTING, "RESETTING")
    (WAIT_FOR_HOME, "WAIT_FOR_HOME");
}
