...
enum StateType
{
  INVALID = 0, IDLE = 1, INITING = 100, CHECK_HOME, WAIT_FOR_ACTIONS, WAIT_FOR_SERVICES, SET_MAT_ACTIONS_READY,

  WAITING = 200,
  MATERIAL_LOADING = 225, ML_MOVE_PICK_APPROACH, ML_WAIT_MOVE_PICK_APPROACH, ML_MOVE_PICK,
  ...
  MATERIAL_UNLOADING = 250,  MATERIAL_UNLOADED,

  STOPPING = 300, STOPPED = 400,

  ABORTING = 500, ABORT_GOALS, CANCEL_REQUESTS, ABORTED = 600,

  RESETTING = 700, WAIT_FOR_HOME,
...
static std::map<int, std::string> STATE_MAP =
    boost::assign::map_list_of(INVALID, "INVALID")(IDLE, "IDLE")(INITING, "INITING")(CHECK_HOME, "CHECK_HOME")(
        WAIT_FOR_ACTIONS, "WAIT_FOR_ACTIONS")(WAIT_FOR_SERVICES, "WAIT_FOR_SERVICES")(SET_MAT_ACTIONS_READY,
                                                                                      "SET_MAT_ACTIONS_READY")(
        WAITING, "WAITING")(MATERIAL_LOADING, "MATERIAL_LOADING")(MATERIAL_LOADED, "MATERIAL_LOADED")(
        MATERIAL_UNLOADING, "MATERIAL_UNLOADING")(MATERIAL_UNLOADED, "MATERIAL_UNLOADED")(STOPPING, "STOPPING")(
        STOPPED, "STOPPED")(ABORTING, "ABORTING")(ABORT_GOALS, "ABORT_GOALS")(CANCEL_REQUESTS, "CANCEL_REQUESTS")(
        ABORTED, "ABORTED")(RESETTING, "RESETTING")(WAIT_FOR_HOME, "WAIT_FOR_HOME");
}
