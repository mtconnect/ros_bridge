...
def open_chuck_client():
    rospy.loginfo('Launched OpenChuck Action CLient')
    # Creates the SimpleActionClient, passing the type of the action
    # (OpenChuckAction) to the constructor.
    client = actionlib.SimpleActionClient('OpenChuckClient', mtconnect_msgs.msg.OpenChuckAction)
    ...
    goal = mtconnect_msgs.msg.OpenChuckGoal()
    goal.open_chuck = 'CLOSED'
...
if __name__ == '__main__':
    try:
        ...
        rospy.init_node('OpenChuckActionClient')
        result = open_chuck_client()
