...
def close_chuck_client():
    rospy.loginfo('Launched CloseChuck Action CLient')
    # Creates the SimpleActionClient, passing the type of the action
    # (CloseChuckAction) to the constructor.
    client = actionlib.SimpleActionClient('CloseChuckClient', mtconnect_msgs.msg.CloseChuckAction)
    ...
    goal = mtconnect_msgs.msg.CloseChuckGoal()
    goal.close_chuck = 'CLOSED'
...
if __name__ == '__main__':
    try:
        ...
        rospy.init_node('CloseChuckActionClient')
        result = close_chuck_client()
